			...
			<div class="sidebar">
               ...
               with font-awesome or any other icon font library -->
						...
						<li class="nav-item has-treeview menu-open"><a href="#"
							class="nav-link active"> <i class="nav-icon fa fa-table"></i>
								<p>
								...
								<table id="example2" class="table table-bordered table-hover">
									...
									<tbody> <!-- 하히후헤호 여기부터 하면됨 -->
										...
										<tr>
											...
											<td><button type="button" class="btn btn-default" onclick="location.href='/getLocalAdvice.do?l_idx=${AdminlocalAdviceList.l_idx }'">관리</button></td>
										</tr>
										</c:forEach>
									</tbody>
