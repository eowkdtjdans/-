			...
			<div class="sidebar">
				...
				<nav class="mt-2">
					<ul class="nav nav-pills nav-sidebar flex-column"
						...
						<li class="nav-item has-treeview">
							<a href="/localAdviceAdminList.do" class="nav-link active"><i class="fas fa-edit"></i>
								<p>게시글 관리</p>
							</a>
						</li>
						<li class="nav-item has-treeview">
							...
							<div class="card-body">
								<table id="example2" class="table table-bordered table-hover">
									...
									<tbody> <!-- 하히후헤호 여기부터 하면됨 -->
										<c:forEach var="AdminlocalAdviceList" items="${AdminlocalAdviceList}">
										<tr>
											<td>${AdminlocalAdviceList.m_id}</td>
											<td>${AdminlocalAdviceList.l_subject}</td>
											<td>${AdminlocalAdviceList.l_content}</td>
											<td>${AdminlocalAdviceList.l_reviewcount}</td>
											<td>${AdminlocalAdviceList.l_date}</td>
											<td><button type="button" class="btn btn-outline-secondary" onclick="location.href='/getLocalAdvice.do?l_idx=${AdminlocalAdviceList.l_idx }'">관리</button></td>
										</tr>
										</c:forEach>
									</tbody>
