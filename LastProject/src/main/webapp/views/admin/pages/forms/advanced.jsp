					...
					<div class="row">
						...
						<div class="col-md-6">
							...
							<div class="card card-success">
								<div class="card-header">
									<h3 class="card-title">iCheck - Checkbox &amp; Radio
										Inputs</h3>
								</div>
								<div class="card-body">
									<!-- Minimal style -->
									...
									<div class="form-group">
										<label> <input type="checkbox" class="minimal" checked>
											...
											disabled> Minimal skin checkbox
										</label>
									</div>
									...
									<div class="form-group">
										<label> <input type="radio" name="r3" class="flat-red"
											...
											class="flat-red" disabled> Flat green skin radio
										</label>
									</div>
								</div>
								<!-- /.card-body -->
								<div class="card-footer">
									Many more skins available. <a
										href="http://fronteed.com/iCheck/">Documentation</a>
								</div>
							</div>
							<!-- /.card -->
						</div>
