			...
			<div class="sidebar">
               ...
               with font-awesome or any other icon font library -->
						...
						<li class="nav-item has-treeview menu-open"><a href="#"
							class="nav-link active"> <i class="nav-icon fa fa-edit"></i>
								<p>
						...
						<div class="col-md-6">
							...
							<div class="card card-success">
								...
								<div class="card-body">
									...
									<br> <input class="form-control form-control-sm"
									...
									<div class="input-group input-group-lg mb-3">
										<div class="input-group-prepend">
											...
											<ul class="dropdown-menu">
												...
												<li class="dropdown-item"><a href="#">Separated
														link</a></li>
											</ul>
										</div>
										<!-- /btn-group -->
									...
									<form role="form">
										...
										<div class="form-group has-success">
											<label class="control-label" for="inputSuccess"><i
												class="fa fa-check"></i> Input with success</label> <input
												type="text" class="form-control" id="inputSuccess"
												placeholder="Enter ...">
										</div>
										<div class="form-group has-warning">
											<label class="control-label" for="inputWarning"><i
												class="fa fa-bell-o"></i> Input with warning</label> <input
