   ...
   function json_insertComment(lc_idx) {
      ...
      $.ajax({
               ...
               success : function(data) {
                  ...
                  var detdetDiv = "<tr><td>&emsp;&emsp;<img src='${.p_route }' class='rounded-circle' id='profileImage3' onerror='this.src='../views/img/people/fuckyou.jpg''>"+data.m_id+"<br>&emsp;&emsp;"+lc_content+"</td></tr>";
