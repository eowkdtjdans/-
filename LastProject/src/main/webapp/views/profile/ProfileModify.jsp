						...
						<div class="card-body">
							...
							<form method="POST" class="my-login-validation" id="form">
								...
								<div class="form-group">
									...
									<textarea rows="5" cols="10"  name="p_hobby" class="form-control">${profile.p_hobby }</textarea>
								</div>
								
								<div class="form-group">
									<label for="langauge" style="text-align : center;">사용가능한 언어</label>
									<textarea rows="5" cols="10" name="p_langauge"  class="form-control" >${profile.p_langauge }</textarea>
								</div>
								
								<div class="form-group">
									<label for="job" style="text-align : center;">직업</label>
									<textarea rows="5" cols="10"   name="p_job" class="form-control">${profile.p_job }</textarea>
								</div>
								
								<div class="form-group">
									<label for="aboutme" style="text-align : center;">자기 소개</label>
									<textarea rows="5" cols="10"  name="p_aboutme" class="form-control" >${profile.p_aboutme }</textarea>
								</div>
								
								<div class="form-group">
									<label for="purpose" style="text-align : center;">목적</label>
									<textarea rows="5" cols="10"  name="p_purpose" class="form-control" >${profile.p_purpose }</textarea>
								</div>
								
								<div class="form-group">
									<label for="visitcountry" style="text-align : center;">방문했던 나라</label>
									<textarea rows="5" cols="10"  name="p_visitcountry" class="form-control" >${profile.p_visitcountry }</textarea>
								</div>
								
								
								
								<div class="form-group m-0">
									<button type="button" class="btn btn-primary btn-block" onclick="modifyProfile(this.form)">
										수정 완료
									</button>
								</div>
