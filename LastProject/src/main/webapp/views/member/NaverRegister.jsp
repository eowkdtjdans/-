...
<script type="text/javascript">
  $(document).ready(function() {
    var m_name = ${result}.response.name;
    var m_id = ${result}.response.email;
    var m_gender = ${result}.response.gender;
    });
                  ...
                  <div class="card-body">
                     ...
                     <form method="POST" class="my-login-validation" id="form">
                        <div class="form-group">
                           ...
                           <input id="m_id" type="text" class="form-control" name="m_id" value="${result}.response.email">
                        </div>
