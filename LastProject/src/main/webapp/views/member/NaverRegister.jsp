                  ...
                  <div>
                     ...
                     <form method="POST"  id="form">
                        ...
                        <div class="form-group">
                           ...
                           <input readonly="readonly" id="naverName" type="text" class="form-control" name="m_name">
                        </div>
                        ...
                        <div class="form-group">
                           ...
                           <input id="naverGender" readonly="readonly" type="text" class="form-control" name="m_gender" required data-eye>
                        </div>
