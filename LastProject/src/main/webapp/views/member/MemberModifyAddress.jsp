      ...
      <table class="border-none">
         <tr>
            <td id="td1">             
               ...
               <input id="autocomplete2" placeholder="" type="text" name="searchKeyword">
               
               <input class="field" id="lat2" type="hidden" name="lat"/>
               <input class="field" id="lng2" type="hidden" name="lng"/>     
